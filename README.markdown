...
Forked from ejschmitt/delayed_job_web, this is the same web interface for delayed job but tweaked for mongoid.
...
```ruby
gem "delayed_job_web",:git => 'https://github.com/omricohen/delayed_job_web_mongoid.git' 
```
